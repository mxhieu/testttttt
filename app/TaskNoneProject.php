...
class TaskNoneProject extends Model
{
    ...
    protected $fillable = ['name', 'code', 'department_id', 'assign_user_id', 'start_at', 'end_at', 'task_type_id', 'task_category_id', 'task_group_id', 'task_priority_id', 'status_id', 'content', 'attach_file', 'remark', 'created_id', 'updated_id'];
