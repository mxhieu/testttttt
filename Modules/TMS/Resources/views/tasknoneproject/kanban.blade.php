                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="list" role="tabpanel">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('tms.tasknoneproject.index')}}" class="float-right btn btn-sm btn-rounded btn-warning">Task List</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <!-- Nav tabs -->
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#department" role="tab">Phòng ban</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#phrase" role="tab">Giai đoạn</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#categories" role="tab">Loại</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#status" role="tab">Trạng thái</a>
                                        </li>
                                    </ul>
                                    <!-- Tab panes -->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="department" role="tabpanel">
                                            @include('tms::component.kanban', ['headingData' => $departmentList, 'data' => $taskNoneProjectList, 'type' => 'department'])
                                        </div>
                                        <div class="tab-pane" id="phrase" role="tabpanel">
                                            @include('tms::component.kanban', ['headingData' => $taskPhraseList, 'data' => $taskNoneProjectList, 'type' => 'phrase'])
                                        </div>
                                        <div class="tab-pane" id="categories" role="tabpanel">
                                            @include('tms::component.kanban', ['headingData' => $taskCategoryList, 'data' => $taskNoneProjectList, 'type' => 'categories'])
                                        </div>
                                        <div class="tab-pane" id="status" role="tabpanel">
                                            @include('tms::component.kanban', ['headingData' => $statusList, 'data' => $taskNoneProjectList, 'type' => 'status'])
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@endsection
@push('style')
<link rel="stylesheet" href="{{ Module::asset('tms:css/tms.css') }}">
...
<script src="{{ Module::asset('tms:js/kanban.js') }}"></script>
