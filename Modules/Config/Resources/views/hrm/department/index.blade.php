                            ...
                            <form action="" method="post">
                                ...
                                <div class="row col-6">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text" id="firstName" name="name" class="form-control" placeholder="phòng ban abc...">
                                    </div>
                                    <div class="form-group col-12">
                                        <label class="control-label">Ghi chú</label>
                                        <textarea class="form-control" name="remark" id="" cols="30" placeholder="phòng ban bao gồm..." rows="10"></textarea>
                                    </div>
                                </div>
...
<script>
    $(function() {
        $('#department-table').DataTable({
            processing: false,
            serverSide: true,
            ajax: '{!! route('config.department.data') !!}',
            columns: [
                { data: 'id', name: 'id' },
                { data: 'name', name: 'name' },
