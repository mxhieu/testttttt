                            ...
                            <form action="" method="post">
                                ...
                                <div class="row col-6">
                                    <div class="form-group col-12">
                                        <label class="control-label">Danh mục công việc</label>
                                        <input type="text" id="firstName" name="name" class="form-control" placeholder="Công việc abc...">
                                    </div>
                                    <div class="form-group col-12">
                                        <label class="control-label">Ghi chú</label>
                                        <textarea class="form-control" name="remark" id="" cols="30" placeholder="Công việc bao gồm..." rows="10"></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane active" id="list" role="tabpanel">
                        <div class="card-body">
                            <div class="col-md-9">
                                ...
                                <table class="table" id="taskcategory-table">
...
<script>
    $(function() {
        $('#taskcategory-table').DataTable({
            processing: false,
            serverSide: true,
            ajax: '{!! route('config.taskcategory.data') !!}',
            columns: [
                { data: 'id', name: 'id' },
                { data: 'name', name: 'name' },
