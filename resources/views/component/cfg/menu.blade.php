    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li>
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span
                            class="hide-menu">Trạng thái<span
                                class="label label-rounded label-success">1</span></span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('config.status.index')}}">Trạng thái</a></li>
                        <li><a href="{{route('config.approve.index')}}">Trạng thái duyệt</a></li>
                    </ul>
                </li>
                <li>
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li>
                            <a href="cfg_crm_customer_category.html">Loại khách hàng</a>
                        </li>
                ...
                <li>
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span
                            class="hide-menu">SCM
                            <span class="label label-rounded label-success">4</span></span></a>
                    <ul aria-expanded="false" class="collapse">
                ...
                <li>
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span
                            class="hide-menu">Công việc<span
                                class="label label-rounded label-success">4</span></span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="cfg_task_category.html">Loại Công việc</a></li>
                        <li><a href="cfg_task_group.html">Nhóm Công việc</a></li>
                        <li><a href="cfg_task_priority.html">Độ ưu tiên</a></li>
                        <li><a href="cfg_task_status.html">Trạng thái</a></li>
                    </ul>
                </li>
                <li>
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="cfg_event_category.html">Loại sự kiện</a></li>
                        <li><a href="cfg_event_group.html">Nhóm sự kiện</a></li>
                        <li><a href="cfg_event_priority.html">Độ ưu tiên</a></li>
                        <li><a href="cfg_event_status.html">Trạng thái</a></li>
                    </ul>
                </li>
                <li>
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span
                ...
                <li>
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span
                            class="hide-menu">Tài chính<span
                                class="label label-rounded label-success">4</span></span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="cfg_finance_unit.html">Đơn vị tiền tệ</a></li>
                        <li><a href="cfg_finance_bank.html">Ngân Hàng</a></li>
                        <li><a href="cfg_finance_payment.html">HT Thanh toán</a></li>
                        <li><a href="cfg_finance_status.html">Trạng thái</a></li>
                    </ul>
                </li>
                <li>
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="{{route('config.position.index')}}">Nhóm nhân sự</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span
                            class="hide-menu">Sản phẩm<span
                                class="label label-rounded label-success">4</span></span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="cfg_product_unit.html">Đơn vị</a></li>
                        <li><a href="cfg_product_category.html">Chủng loại</a></li>
                        <li><a href="cfg_product_group.html">Nhóm</a></li>
                        <li><a href="cfg_product_list.html">Danh sách</a></li>
                    </ul>
                </li>
                <li>
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span
                ...
                <li>
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span
                            class="hide-menu">Cấu hình chung
                            <span class="label label-rounded label-success">3</span></span></a>
                    <ul aria-expanded="false" class="collapse">
